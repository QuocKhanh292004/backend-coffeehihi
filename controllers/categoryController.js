...
exports.getAllCategories = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(500)
      .json(
        responseUtil.serverError(req, "Lỗi server khi lấy danh sách danh mục"),
      );
  }
};
...
exports.getCategoryDetail = async (req, res) => {
  ...
  try {
    ...
    return res.json(
      responseUtil.success(req, "Lấy thông tin danh mục thành công", category),
    );
  } catch (error) {
    ...
    return res
      .status(500)
      .json(
        responseUtil.serverError(req, "Lỗi server khi lấy thông tin danh mục"),
      );
  }
};
...
exports.updateCategory = async (req, res) => {
  ...
  try {
    ...
    if (req.file) {
      ...
      imagePath = require("../utils/imageUtil").updateCategoryImage(
        req.file.buffer,
        id,
    ...
    const [updatedRows] = await MenuCategory.update(updatePayload, {
      where: { category_id: id, is_delete: false },
    });
    ...
    return res
      .status(500)
      .json(responseUtil.serverError(req, "Lỗi server khi cập nhật danh mục"));
  }
};
...
exports.deleteCategory = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(500)
      .json(responseUtil.serverError(req, "Lỗi server khi xóa danh mục"));
  }
};
...
exports.uploadCategoryImage = async (req, res) => {
  ...
  try {
    ...
    const imagePath = imageUtil.updateCategoryImage(
      req.file.buffer,
      id,
      category.category_image,
    );
    ...
    return res.json(
      responseUtil.success(
        req,
        "Tải lên ảnh danh mục thành công",
        updatedCategory,
      ),
    );
  } catch (error) {
    return res
      .status(500)
      .json(
        responseUtil.serverError(req, "Lỗi server khi tải lên ảnh danh mục"),
      );
  }
};
...
exports.deleteCategoryImageHandler = async (req, res) => {
  ...
  try {
    ...
    if (!category.category_image) {
      return res
        .status(400)
        .json(responseUtil.badRequest(req, "Danh mục không có ảnh để xóa"));
    }
    ...
    imageUtil.attachFullUrls(updatedCategory, req);
    return res.json(
      responseUtil.success(req, "Xóa ảnh danh mục thành công", updatedCategory),
    );
  } catch (error) {
    return res
      .status(500)
      .json(responseUtil.serverError(req, "Lỗi server khi xóa ảnh danh mục"));
  }
};
